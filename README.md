In this login system user can signup firstly as user or as client after successfully signup user can directly render to the login page.Then the user can login by thier own credentials.
